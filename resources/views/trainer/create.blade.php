...
@section('title'){{ 'Trainer Create' }}@endsection
@section('header.css')
    <style>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form class="form-wizard" action="{{ route('trainer.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row ">
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="" name="field" type="text" placeholder="Enter Trainer Field" value="{{ old('field') }}" required>
